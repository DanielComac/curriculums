...
app.post('/curriculum/agregar', (req, res) =>{
    ...
    db.query(sql, [nombre, apellido, nacimiento, email, celular, calle, colonia, cp, sexo, institucion, titulo, campo_estudio, graduacion, nombre_empresa, puesto, fecha_inicio, fecha_fin, descripcion, competencias, hobbies, certificaciones, valores, idiomas, facebook, instagram, twitter, linkedIn
    ], (err, result) =>{
        if(err){
            res.send({
                status: 100,
